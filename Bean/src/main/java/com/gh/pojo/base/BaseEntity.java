...
public abstract class BaseEntity implements Serializable {
	 ...
	 * @return ID集合
	 */
	public static <T extends BaseEntity> List<Integer> idList(List<T> entities) {
...
//		return ids;
     ...
     * @return ID-实体Map
     */
	public static <T extends BaseEntity> Map<Integer, T> idEntityMap(List<T> entities) {
//		Map<Long, T> idEntityMap = new HashMap<>();
//		entities.forEach(entity -> idEntityMap.put(entity.getId(), entity));
//		return idEntityMap;

		Map<Integer, T> idMap = entities.stream().collect(Collectors.toMap(T::getId, entity -> entity));
		return idMap;
	}
